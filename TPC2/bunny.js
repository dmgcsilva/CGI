...
//calculates the normal vector of the given face
...
//returns an array with all the faces that the given vertex is part of
...
//checks if the given edge already exits in bunny_edges
